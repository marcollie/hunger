$('#btnsoupe').click(function(e){    
  ...
  $('#btnsoupe').css('background-color', '#E8C300');
});
...
$('#btnpizza').click(function(e){    
  ...
  $('.menutitle ul li').css('background-color', 'white');
  $('#btnpizza').css('background-color', '#E8C300');
});
...
$('#btnpasta').click(function(e){    
  ...
  $('.menutitle ul li').css('background-color', 'white');
  $('#btnpasta').css('background-color', '#E8C300');
});
...
$('#btndesert').click(function(e){    
  ...
  $('.menutitle ul li').css('background-color', 'white');
  $('#btndesert').css('background-color', '#E8C300');
});
...
$('#btnwine').click(function(e){    
  ...
  $('.menutitle ul li').css('background-color', 'white');
  $('#btnwine').css('background-color', '#E8C300');
});
...
$('#btnbeer').click(function(e){    
  ...
  $('.menutitle ul li').css('background-color', 'white');
  $('#btnbeer').css('background-color', '#E8C300');
});
...
$('#btndrinks').click(function(e){    
  ...
  $('.menutitle ul li').css('background-color', 'white');
  $('#btndrinks').css('background-color', '#E8C300');
});